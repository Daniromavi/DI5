...
public class VistaEliminarArticulos extends JFrame {
    ...
    public VistaEliminarArticulos() {
    	ControladorEliminarArticulos Controlador = new ControladorEliminarArticulos(this);
        ...
        bttnCancelarEliminarArticulo.addActionListener(Controlador);
        ...
        bttnEliminarArticulo.addActionListener(Controlador);
        ...
        // Cargar los artículos en el Choice al iniciar la vista
        cargarArticulos();
    }
    ...
    public void cargarArticulos() {
        choice.removeAll();
        for (String articulo : conexion.obtenerArticulos()) {
            choice.add(articulo);
        }
    }
}
