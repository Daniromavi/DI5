...
public class VistaModificacionArticulo extends JFrame {
    ...
    private int idArticulo2; // Variable para almacenar el ID
 ...
 // Constructor con el ID del artículo, modeloArticulos y vistaModificacionArticulo
    public VistaModificacionArticulo(int idArticulo2, ModeloArticulos ModeloArticulos, VistaModificarArticulos vistaModificarArticulos) {
        this.idArticulo2 = idArticulo2; // Asignar el ID del artículo
        this.ModeloArticulos = ModeloArticulos; // Asignar el modelo de artículos
        this.VistaModificarArticulos = vistaModificarArticulos; // Asignar la vista desde el controlador
    ...
    public void iniciarVista() {
        // Código para iniciar la vista de modificación (por ejemplo, hacer visible la ventana)
        setVisible(true);
    }
