...
--
-- Table structure for table `ticket_articulo`
--

DROP TABLE IF EXISTS `ticket_articulo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ticket_articulo` (
  ...
  KEY `ticket_articulo_ibfk_2` (`id_articulo`),
  CONSTRAINT `ticket_articulo_ibfk_1` FOREIGN KEY (`id_ticket`) REFERENCES `tickets` (`idticket`)
